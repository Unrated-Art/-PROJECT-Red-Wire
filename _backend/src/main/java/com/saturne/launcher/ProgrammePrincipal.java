  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      Catalogue cat = new Catalogue(
        /*new Auteur(1, "Xavier", "Blanc")*/"Responsable Catalogue",
        "22/06/2022"
      );
      ...
      Formation f_java = new Formation(
        "OB101",
        LieuFormation.Paris_La_Defense.toString(),
        true,
        10,
        "Programmation Orientée Objet",
        "Développer des applications web en java",
        "tout public",
        "Programme détaillé de la formation Java"
      );
      ...
      Formation html_css = new Formation(
        "IW208",
        LieuFormation.Bordeaux.toString(),
        true,
        30,
        "Algorithmique",
        "Créer des sites web dynamiques avec html5 et css3",
        "-29 ans",
        "Programme détaillé de la formation HTML5/CSS3"
      );
